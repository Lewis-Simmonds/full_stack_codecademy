...
function updateResults(){
  ...
  const averageSalaryByRole = formatNumber(getAverageSalaryByRole());
  const averageSalaryByCompany = formatNumber(getAverageSalaryByCompany());
  const salary = formatNumber(getSalaryAtCompany());
